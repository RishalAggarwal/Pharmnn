...
python inference.py --train_data data/chemsplit_train0_with_ligand.pkl  --create_dataset --verbose --model models/default_chemsplit0_best_model.pkl --negative_output data/obabel_chemsplit_0_negatives
